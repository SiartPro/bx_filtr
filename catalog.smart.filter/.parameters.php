...
// custom parameters by Siart
$arProperties = array();
foreach(CIBlockSectionPropertyLink::GetArray($arCurrentValues['IBLOCK_ID']) as $intId => $arFields) {
    if ($arFields['SMART_FILTER'] !== 'Y') continue;
    if ($arFields['ACTIVE'] === 'N') continue;

    $rsProperty = CIBlockProperty::GetByID($arFields['PROPERTY_ID']);
    $arItem = $rsProperty->GetNext();

    $arProperties[$arItem['CODE']] = $arItem['NAME'];
}

$arComponentParameters['PARAMETERS']['MAX_COUNT_ITEM_SEF'] = array(
    'PARENT' => 'OTHERS',
    'NAME' => GetMessage('CP_BCSF_MAX_COUNT_ITEM_SEF'),
    'TYPE' => 'STRING',
    'DEFAULT' => '100',
);
$arComponentParameters['PARAMETERS']['PROPERTIES_ALLOW_SEF'] = array(
    'PARENT' => 'OTHERS',
    'NAME' => GetMessage('CP_BCSF_PROPERTIES_ALLOW_SEF'),
    'TYPE' => 'LIST',
    'MULTIPLE' => 'Y',
    'VALUES' => $arProperty_OffersWithoutFile,
);
$arComponentParameters['PARAMETERS']['PROPERTIES_USE_CODE'] = array(
    'PARENT' => 'OTHERS',
    'NAME' => GetMessage('CP_BCSF_PROPERTIES_USE_CODE'),
    'TYPE' => 'LIST',
    'MULTIPLE' => 'Y',
    'VALUES' => $arProperty_OffersWithoutFile,
);
$arComponentParameters["PARAMETERS"]['TRANSLATE_LIST_VALUE'] = array(
    'PARENT' => 'OTHERS',
    'NAME' => GetMessage('CP_BCSF_TRANSLATE_LIST_VALUE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
);
$arComponentParameters["PARAMETERS"]['ADD_CHAIN_ITEMS'] = array(
    'PARENT' => 'OTHERS',
    'NAME' => GetMessage('CP_BCSF_ADD_CHAIN_ITEMS'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
);
$arComponentParameters["PARAMETERS"]['ADD_META'] = array(
    'PARENT' => 'OTHERS',
    'NAME' => GetMessage('CP_BCSF_ADD_META'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
);
