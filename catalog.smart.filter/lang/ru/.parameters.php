...
$MESS["CP_BCSF_MAX_COUNT_ITEM_SEF"] = "Максимальное количество выбранных опций, для которых формируется ЧПУ";
$MESS["CP_BCSF_PROPERTIES_ALLOW_SEF"] = "Список свойств, для которых формируется ЧПУ";
$MESS["CP_BCSF_PROPERTIES_USE_CODE"] = "Список свойств, для которых необходимо использовать символьный код в ЧПУ";
$MESS["CP_BCSF_TRANSLATE_LIST_VALUE"] = "Транслитерировать значение свойства типа список";
$MESS["CP_BCSF_ADD_CHAIN_ITEMS"] = "Добавлять выбранные параметры в цепочку навигации";
$MESS["CP_BCSF_HL_TABLE_NAME"] = "Таблица highload с метатегами для адресов";
?>